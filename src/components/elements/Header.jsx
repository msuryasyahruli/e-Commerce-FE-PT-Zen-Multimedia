        ...
        <>
            <header className='grid grid-cols-3 h-16 max-md:h-12 bg-gray-400 items-center px-6 sticky top-0 max-md:px-4 max-md:grid-cols-2'>
                <div className='flex items-center gap-2'>
                    ...
                    <Link to="/" className='font-bold text-3xl max-md:hidden'>Shop app</Link>
                </div>
                <div className='flex justify-center max-md:justify-end'>
                    <div className='w-96 h-10 bg-white flex items-center justify-end rounded-full px-3 max-md:h-8 max-md:px-2 gap-1 max-md:hidden'>
                ...
                <div className='flex items-center justify-end gap-4 max-md:hidden'>
                    <Link><IoBagHandleOutline className='w-9 h-9 hover:bg-gray-500 rounded-full p-1' /></Link>
                    <Link to='/cart'>
